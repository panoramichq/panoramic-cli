...
FROM db.schema.metric_table_hourly AS db_schema_metric_table_hourly_0f32eb13951cfe30 ) GROUP BY __data_source, ad_id ORDER BY impressions DESC NULLS LAST, ad_id ASC NULLS LAST
 LIMIT 1 OFFSET 2