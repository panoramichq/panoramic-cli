...
FROM schema.metric_table_hourly AS schema_metric_table_hourly_4ba9264ca9b14f09 ) GROUP BY __data_source, ad_id ORDER BY impressions DESC NULLS LAST, ad_id ASC NULLS LAST
 LIMIT 1 OFFSET 2